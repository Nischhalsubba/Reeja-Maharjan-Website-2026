...
|---|---|---|---|---|
| Name + role | Hero | `src/components/Hero.astro` | Covered | Full name and registered nurse role are shown in hero. |
...
| Location | Hero + Contact | `src/components/Hero.astro`, `src/components/ContactSection.astro` | Covered | City-level location is used. |
| Summary paragraph | Profile | `src/components/ProfileSection.astro` | Covered | Concise resume-grounded summary. |
...
| Role responsibilities bullets | Experience | `src/components/ExperienceSection.astro` | Covered | Max 3 bullets per role. |
...
| Detailed skill descriptions | Skill Details | `src/components/SkillDetailsSection.astro` | Covered | Dedicated expanded section. |
...
| Contact details available on request note | Recommendations | `src/components/RecommendationsSection.astro` | Covered | Included for privacy-safe references. |
