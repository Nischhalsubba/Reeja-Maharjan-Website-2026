...
```mermaid
flowchart TD
    ROOT["Reeja-Maharjan-Website-2026 / work/rw12-rw13-pages-browser-checks"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["public/"]
    ROOT --> P3["scripts/"]
...
```mermaid
flowchart LR
    CHANGE["Change on work/rw12-rw13-pages-browser-checks"] --> CHECK["Tests and quality checks"]
