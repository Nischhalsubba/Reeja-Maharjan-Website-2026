...
**Branch-aware technical guide for [`agent/deployment-recovery`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/deployment-recovery)**

<p><img alt="branch: agent/deployment-recovery" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Fdeployment-recovery&color=5965F2&style=flat-square"> <img alt="Astro" src="https://img.shields.io/static/v1?label=&message=Astro&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/deployment-recovery"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/codespaces/new?ref=agent%2Fdeployment-recovery"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/deployment-recovery`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`.github/workflows/build-check.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/deployment-recovery/.github/workflows/build-check.yml)
- [`.github/workflows/production-smoke.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/deployment-recovery/.github/workflows/production-smoke.yml)
- [`README.md`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/deployment-recovery/README.md)
- [`package.json`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/deployment-recovery/package.json)
- [`public/_headers`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/deployment-recovery/public/_headers)
- [`scripts/generate-build-fingerprint.mjs`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/deployment-recovery/scripts/generate-build-fingerprint.mjs)
- [`scripts/smoke-production.mjs`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/deployment-recovery/scripts/smoke-production.mjs)
- [`src/lib/mobileNavA11y.ts`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/deployment-recovery/src/lib/mobileNavA11y.ts)
...
```mermaid
flowchart TD
    ROOT["Reeja-Maharjan-Website-2026 / agent/deployment-recovery"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["public/"]
    ROOT --> P3["scripts/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/deployment-recovery/public), [`src`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/deployment-recovery/src) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/deployment-recovery/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/deployment-recovery/.github), [`scripts`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/deployment-recovery/scripts) |
...
```mermaid
flowchart LR
    CHANGE["Change on agent/deployment-recovery"] --> CHECK["Tests and quality checks"]
...
| Branch | [`agent/deployment-recovery`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/deployment-recovery) |
