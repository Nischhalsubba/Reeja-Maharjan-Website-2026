...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/minimal-nurse-redesign`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/minimal-nurse-redesign). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/minimal-nurse-redesign"]
