...
**Branch-aware technical guide for [`codex/nurse-theme-redesign`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/codex/nurse-theme-redesign)**

<p><img alt="branch: codex/nurse-theme-redesign" src="https://img.shields.io/static/v1?label=&message=branch%3A%20codex%2Fnurse-theme-redesign&color=5965F2&style=flat-square"> <img alt="Astro" src="https://img.shields.io/static/v1?label=&message=Astro&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/codex/nurse-theme-redesign"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/codespaces/new?ref=codex%2Fnurse-theme-redesign"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `codex/nurse-theme-redesign`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/README.md)
- [`package-lock.json`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/package-lock.json)
- [`public/nurse-care-editorial-hero.png`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/public/nurse-care-editorial-hero.png)
- [`src/components/CertificationsSection.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/src/components/CertificationsSection.astro)
- [`src/components/ContactSection.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/src/components/ContactSection.astro)
- [`src/components/ExperienceSection.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/src/components/ExperienceSection.astro)
- [`src/components/Hero.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/src/components/Hero.astro)
- [`src/components/ProfileSection.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/src/components/ProfileSection.astro)
- [`src/components/RoleFitSection.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/src/components/RoleFitSection.astro)
- [`src/components/SkillsSection.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/src/components/SkillsSection.astro)
- [`src/layouts/BaseLayout.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/src/layouts/BaseLayout.astro)
- [`src/pages/blog/[slug].astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/src/pages/blog/%5Bslug%5D.astro)
...
```mermaid
flowchart TD
    ROOT["Reeja-Maharjan-Website-2026 / codex/nurse-theme-redesign"]
    ROOT --> P0[".github/"]
    ROOT --> P1["public/"]
    ROOT --> P2["src/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/codex/nurse-theme-redesign/public), [`src`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/codex/nurse-theme-redesign/src) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/codex/nurse-theme-redesign/.github) |
...
flowchart TD
    ...
    R0 --> F2["src/pages/404.astro"]
    R0 --> F3["src/pages/blog/index.astro"]
    R0 --> F4["src/pages/blog/(slug).astro"]
```
...
```mermaid
flowchart LR
    CHANGE["Change on codex/nurse-theme-redesign"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/build-check.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/codex/nurse-theme-redesign/.github/workflows/build-check.yml)
...
| Branch | [`codex/nurse-theme-redesign`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/codex/nurse-theme-redesign) |
