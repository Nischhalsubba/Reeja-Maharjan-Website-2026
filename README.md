...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`work/rw12-rw13-pages-browser-checks`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw12-rw13-pages-browser-checks). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on work/rw12-rw13-pages-browser-checks"]
