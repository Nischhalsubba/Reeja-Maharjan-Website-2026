...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`work/rw3-cloudflare-cutover-runbook`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw3-cloudflare-cutover-runbook). It is generated from the files present on this branch and preserves the project-authored README below.
...
flowchart TD
    ...
    ROOT --> P11[".nvmrc"]
    ROOT --> P12[".prettierignore"]
    ROOT --> P13[".prettierrc"]
    ROOT --> P14["astro.config.mjs"]
    ROOT --> P15["eslint.config.js"]
...
```mermaid
flowchart LR
    CHANGE["Change on work/rw3-cloudflare-cutover-runbook"]
