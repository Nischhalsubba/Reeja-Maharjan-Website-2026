...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/complete-all-in-progress-tasks`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/complete-all-in-progress-tasks). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/complete-all-in-progress-tasks"]
