...
**Branch-aware technical guide for [`work/rw5-rw6-recruiter-homepage`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw5-rw6-recruiter-homepage)**

<p><img alt="branch: work/rw5-rw6-recruiter-homepage" src="https://img.shields.io/static/v1?label=&message=branch%3A%20work%2Frw5-rw6-recruiter-homepage&color=5965F2&style=flat-square"> <img alt="Astro" src="https://img.shields.io/static/v1?label=&message=Astro&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw5-rw6-recruiter-homepage"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/codespaces/new?ref=work%2Frw5-rw6-recruiter-homepage"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `work/rw5-rw6-recruiter-homepage`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/README.md)
- [`src/components/RecruiterContact.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/src/components/RecruiterContact.astro)
- [`src/components/RecruiterExperience.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/src/components/RecruiterExperience.astro)
- [`src/components/RecruiterHero.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/src/components/RecruiterHero.astro)
- [`src/components/RecruiterHomepage.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/src/components/RecruiterHomepage.astro)
- [`src/components/RecruiterProof.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/src/components/RecruiterProof.astro)
- [`src/components/RecruiterRolePaths.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/src/components/RecruiterRolePaths.astro)
- [`src/pages/index.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/src/pages/index.astro)
- [`src/styles/home-recruiter.css`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/src/styles/home-recruiter.css)
...
```mermaid
flowchart TD
    ROOT["Reeja-Maharjan-Website-2026 / work/rw5-rw6-recruiter-homepage"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["public/"]
    ROOT --> P3["scripts/"]
    ROOT --> P4["src/"]
    ROOT --> P5["src-legacy-v55/"]
    ROOT --> P6["src-old-v55/"]
    ROOT --> P7[".gitignore"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw5-rw6-recruiter-homepage/public), [`src`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw5-rw6-recruiter-homepage/src) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw5-rw6-recruiter-homepage/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw5-rw6-recruiter-homepage/.github), [`scripts`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw5-rw6-recruiter-homepage/scripts) |
...
flowchart TD
    ...
    APP --> R0["src/pages"]
    APP --> R1["public"]
    R0 --> F0["src/pages/clinical-research.astro"]
    R0 --> F1["src/pages/404.astro"]
    R0 --> F2["src/pages/hire-reeja.astro"]
    R0 --> F3["src/pages/index.astro"]
    R0 --> F4["src/pages/nursing-practice.astro"]
    R0 --> F5["src/pages/maternal-health.astro"]
    R0 --> F6["src/pages/cv.astro"]
    R0 --> F7["src/pages/blog/index.astro"]
    R0 --> F8["src/pages/blog/(slug).astro"]
```
...
```mermaid
flowchart LR
    CHANGE["Change on work/rw5-rw6-recruiter-homepage"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/build-check.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/.github/workflows/build-check.yml)
- [`.github/workflows/production-smoke.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/work/rw5-rw6-recruiter-homepage/.github/workflows/production-smoke.yml)
...
| Branch | [`work/rw5-rw6-recruiter-homepage`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/work/rw5-rw6-recruiter-homepage) |
