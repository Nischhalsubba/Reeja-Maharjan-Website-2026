...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`final/release-acceptance-closure`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on final/release-acceptance-closure"]
