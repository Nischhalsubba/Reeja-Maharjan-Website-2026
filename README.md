...
flowchart TD
    ...
    ROOT --> P0["public/"]
    ROOT --> P1["src/"]
    ROOT --> P2["src-legacy-v55/"]
    ROOT --> P3["src-old-v55/"]
    ROOT --> P4[".gitignore"]
    ROOT --> P5[".node-version"]
    ROOT --> P6[".nvmrc"]
    ROOT --> P7[".prettierignore"]
    ROOT --> P8[".prettierrc"]
    ROOT --> P9["astro.config.mjs"]
    ROOT --> P10["eslint.config.js"]
    ROOT --> P11["package-lock.json"]
    ROOT --> P12["package.json"]
    ROOT --> P13["PARITY.md"]
    ROOT --> P14["RESUME_COVERAGE.md"]
...
```mermaid
flowchart LR
    CHANGE["Change on portfolio-priority-roadmap"] --> CHECK["Tests and quality checks"]
