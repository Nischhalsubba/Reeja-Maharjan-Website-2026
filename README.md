...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/unified-site-system`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/unified-site-system). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/unified-site-system"]
