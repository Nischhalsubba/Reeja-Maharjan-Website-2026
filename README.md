...
**Branch-aware technical guide for [`final/release-acceptance-closure`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure)**

<p><img alt="branch: final/release-acceptance-closure" src="https://img.shields.io/static/v1?label=&message=branch%3A%20final%2Frelease-acceptance-closure&color=5965F2&style=flat-square"> <img alt="Astro" src="https://img.shields.io/static/v1?label=&message=Astro&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/codespaces/new?ref=final%2Frelease-acceptance-closure"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `final/release-acceptance-closure`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/final/release-acceptance-closure/README.md)
...
```mermaid
flowchart TD
    ROOT["Reeja-Maharjan-Website-2026 / final/release-acceptance-closure"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["public/"]
    ROOT --> P3["scripts/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure/public), [`src`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure/src) |
| Quality | [`tests`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure/.github), [`scripts`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure/scripts) |
...
- [`tests`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure/tests)
...
```mermaid
flowchart LR
    CHANGE["Change on final/release-acceptance-closure"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/browser-quality.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/final/release-acceptance-closure/.github/workflows/browser-quality.yml)
- [`.github/workflows/build-check.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/final/release-acceptance-closure/.github/workflows/build-check.yml)
- [`.github/workflows/cloudflare-account-audit.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/final/release-acceptance-closure/.github/workflows/cloudflare-account-audit.yml)
- [`.github/workflows/production-diagnostics.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/final/release-acceptance-closure/.github/workflows/production-diagnostics.yml)
- [`.github/workflows/production-smoke.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/final/release-acceptance-closure/.github/workflows/production-smoke.yml)
- [`.github/workflows/visual-regression.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/final/release-acceptance-closure/.github/workflows/visual-regression.yml)
...
| Branch | [`final/release-acceptance-closure`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/final/release-acceptance-closure) |
