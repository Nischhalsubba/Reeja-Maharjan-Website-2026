...
**Branch-aware technical guide for [`agent/seo-traffic-growth`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/seo-traffic-growth)**

<p><img alt="branch: agent/seo-traffic-growth" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Fseo-traffic-growth&color=5965F2&style=flat-square"> <img alt="Astro" src="https://img.shields.io/static/v1?label=&message=Astro&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/seo-traffic-growth"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/codespaces/new?ref=agent%2Fseo-traffic-growth"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/seo-traffic-growth`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/README.md)
- [`src/components/Footer.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/src/components/Footer.astro)
- [`src/components/Header.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/src/components/Header.astro)
- [`src/layouts/BaseLayout.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/src/layouts/BaseLayout.astro)
- [`src/pages/blog/[slug].astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/src/pages/blog/%5Bslug%5D.astro)
- [`src/pages/clinical-research.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/src/pages/clinical-research.astro)
- [`src/pages/hire-reeja.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/src/pages/hire-reeja.astro)
- [`src/pages/maternal-health.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/src/pages/maternal-health.astro)
- [`src/pages/nursing-practice.astro`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/src/pages/nursing-practice.astro)
- [`src/styles/traffic-pages.css`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/src/styles/traffic-pages.css)
...
```mermaid
flowchart TD
    ROOT["Reeja-Maharjan-Website-2026 / agent/seo-traffic-growth"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["public/"]
    ROOT --> P3["src/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/seo-traffic-growth/public), [`src`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/seo-traffic-growth/src) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/seo-traffic-growth/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/seo-traffic-growth/.github) |
...
```mermaid
flowchart LR
    CHANGE["Change on agent/seo-traffic-growth"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/build-check.yml`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/blob/agent/seo-traffic-growth/.github/workflows/build-check.yml)
...
| Branch | [`agent/seo-traffic-growth`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/agent/seo-traffic-growth) |
