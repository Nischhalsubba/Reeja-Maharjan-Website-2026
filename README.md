...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`fix/complete-in-progress-blockers`](https://github.com/Nischhalsubba/Reeja-Maharjan-Website-2026/tree/fix/complete-in-progress-blockers). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on fix/complete-in-progress-blockers"]
