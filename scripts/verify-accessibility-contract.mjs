...
const baseStyleSource = await readFile(new URL('../src/styles/base.css', import.meta.url), 'utf8');
const failures = [];
...
if (!baseStyleSource.includes('prefers-reduced-motion: reduce')) failures.push('Base styles lack reduced-motion handling.');
